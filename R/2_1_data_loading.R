...
## setting a common data input for all province

Cdb$Zamora$Hoja3$Hoja50 <- str_pad(Cdb$Zamora$Hoja3$Hoja50, 4, pad = "0")
...
names(SpMp) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                 "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
...
names(SpPlot) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                   "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
SpPlot <- do.call("rbind", SpPlot)
...
names(Shrubs) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                   "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
...
names(TreesI3) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                    "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
...
names(TreesI2) <-c("Almeria", "Cadiz", "Cordoba",  "Granada",
                   "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
...
names(Plots) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                  "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
...
names(Reg) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
Reg <- do.call("rbind", Reg)
...
levels(DataMp$Provincia) <- c("Almeria", "Cadiz", "Cordoba",  "Granada",
                              "Huelva", "Jaen", "Lugo", "Malaga", "Ourense", "Sevilla", "Toledo", "Zamora")
